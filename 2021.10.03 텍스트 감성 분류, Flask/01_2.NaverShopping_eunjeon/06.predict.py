...
# 모델 불러오기
loaded_model = load_model("../98.models/NaverShoppingReview/best_model_GRU.h5")
# loaded_model = load_model("../98.models/NaverShoppingReview/best_model_LSTM.h5")
